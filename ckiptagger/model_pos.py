...
class Model:
    ...
    def create_encoder(self):
        ...
        with tf.variable_scope(self.name):
            ...
            #original cw_h, _, _ = self.bilstm.transform(cw_v, self.s_l) # [batch, s_l_max, hidden_d*2]
    ...
    def predict_label_for_a_batch(self, sample_list):
        ...
        return prediction_list,logits, hiddenState, labelindex_sequence_list ,s_l, o_mask, self.label_list
