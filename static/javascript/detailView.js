    ...
    var characters = each_sentence.selectAll(null)
        ...
        .on("click",function(d){ 
            ...
            $.ajax({ 
                type: "POST", 
                url: "/wordCloud", 
                data: {"open_tsne":0,"perp":perp,"click_index":d.index,"changeWS":0,"wordCloudClick":1,
                "wordCloudSelect":0},
    ...
    characters.selectAll()
        ...
        .on("mousemove", function(d){
            ...
            .style("width", function(d){
                return d.predicts_order.length*18 +"px"
            })
...
//end returnIndex_ws
    ...
    function changeWS(d,i){
        ...
        switch(range_mod){
            ...
            case 0:
                console.log("case0",d.index_article.char)
                new_begin = d.index_article.char
                map_begin = i
                break;
            case 1:
                new_end = d.index_article.char
                map_end = i
                console.log("case1",d.index_article.char)
                $.ajax({ 
                    type: "POST", 
                    url: "/changeWS", 
                    data: {"open_tsne":0,"perp":perp,"changeWS":1,"character_begin":new_begin,"character_end":new_end,
                        "map_begin":map_begin,"map_end":map_end,
                        "article":d.index_article.article,hithere:JSON.stringify(select_context)},
                    success: function(data,textStatus,jqXHR ){ 
